...
void Engine::createInstance()
{
  ...
  if (settings.validation_enabled()) layers.emplace_back(VK_VALIDATION_LAYER_NAME);
  ...
  if (settings.portability_enabled()) ci_instance.flags |= vk::InstanceCreateFlagBits::eEnumeratePortabilityKHR;
